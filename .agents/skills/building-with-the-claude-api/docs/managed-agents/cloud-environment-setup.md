...
Cloud containers include common runtimes out of the box. See [Container reference](cloud-environment-setup.md) for the full list of pre-installed languages, databases, and utilities.