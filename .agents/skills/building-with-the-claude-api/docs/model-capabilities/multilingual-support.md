...
<sup>1</sup> With [extended thinking](extended-thinking.md).
...
Also follow the general [prompt engineering guidelines](../best-practices/prompt-engineering/overview.md) to better improve Claude's performance.
