...
The Vertex API for accessing Claude is nearly-identical to the [Messages API](https://docs.claude.com/en/docs/api/messages/create) and supports all of the same options, with two key differences:

* In Vertex, `model` is not passed in the request body. Instead, it is specified in the Google Cloud endpoint URL.
* In Vertex, `anthropic_version` is passed in the request body (rather than as a header), and must be set to the value `vertex-2023-10-16`.

Vertex is also supported by Anthropic's official [client SDKs](https://docs.claude.com/en/docs/api/client-sdks). This guide walks you through making a request to Claude on Vertex AI using one of Anthropic's client SDKs.
...
First, install Anthropic's [client SDK](https://docs.claude.com/en/docs/api/client-sdks) for your language of choice.
...
See the [client SDKs](https://docs.claude.com/en/docs/api/client-sdks) and the official [Vertex AI docs](https://cloud.google.com/vertex-ai/docs) for more details.

Claude is also available through [Amazon Bedrock](amazon-bedrock.md) and [Microsoft Foundry](microsoft-foundry.md).
...
## Feature support
For all currently supported features on Vertex AI, see [API features overview](https://docs.claude.com/en/docs/api/overview).

### Context window

Claude Opus 4.7, Claude Opus 4.6, and Claude Sonnet 4.6 have a [1M-token context window](../context-management/context-windows.md) on Vertex AI. Other Claude models, including Sonnet 4.5 and Sonnet 4 (deprecated), have a 200k-token context window.
...
puts message.content.first.textI have 
```
</CodeGroup>
