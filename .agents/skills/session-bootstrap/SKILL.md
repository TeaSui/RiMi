...
If AGENTS.md says "don't use TDD" and a skill says "always use TDD," the user wins. "Add X" / "Fix Y" specify the *what*, not the *how* — they do not authorize skipping workflow skills.
