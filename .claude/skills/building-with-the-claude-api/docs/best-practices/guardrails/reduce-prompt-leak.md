...
<section title="Example: Safeguarding proprietary analytics">
    ...
    Notice that this system prompt is still predominantly a role prompt, which is the [most effective way to use system prompts](../prompt-engineering/prompting-best-practices.md#give-claude-a-role).
